...
<html lang="fr">
      ...
      <link rel="icon" href="favicon.ico" />
         ...
         <?php $bdd = new PDO('mysql:host=localhost;dbname=projet;charset=utf8', 'admin', 'admin'); ?>
      ...
      <div class="row"> 
        <div class="col-sm-12 blog-main">
          ...
          <div class="form-group col-md-2 bloc2">
             ...
             <a href="commentaires.php?idP='<?php echo $donnees['numProposition'] ?>'"> <button class="btn btn-sm ml-2 btn-primary" type="submit" value="Envoyer">Commenter</button> </a>
